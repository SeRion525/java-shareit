...
@Component
public class PastBookingRequestHandler extends BookingRequestHandler {
    public PastBookingRequestHandler(FutureBookingRequestHandler nextHandler, BookingRepository bookingRepository) {
        super(BookingState.PAST, nextHandler, bookingRepository);
    }
